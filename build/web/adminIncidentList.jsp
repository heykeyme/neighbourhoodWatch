<%-- 
    Document   : adminUpdateIncident
    Created on : Feb 20, 2025, 11:30:37 PM
    Author     : Heykeyme
--%>
...
//        conn = DriverManager.getConnection("jdbc:mysql://localhost:1527/userdb", "app", "app");
        ...
        String query = "SELECT incident_id, title, description FROM incidents where admin_id = 2";
...
%>
                    <tr>
                        ...
                        <td><%= description %></td>
                        <td>
                            <a href="adminUpdateIncident.jsp?id=<%= incidentId %>&title=<%= title %>&description=<%= description %>" class="edit-btn">Update Status</a>
                        </td>
                    </tr>
<%
                }
